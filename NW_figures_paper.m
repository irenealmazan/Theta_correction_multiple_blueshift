...
[err_final,rho_shift] = FiguresForPaper.calculate_error_realspace(NW*sqrt(mncntrate/mn),rho_conj,[65],'1',16,delta_thscanvals,ki_o,kf_o,kf_o-ki_o,d2_bragg,X,Y,Z);
