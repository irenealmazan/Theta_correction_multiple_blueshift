...
er_iter = 1;
flagER = 1;
[retrphase,newobj,err_ERHIO,struct_rho_iter,counter] = Phretrieval_functions.do_ERHIO(err_ERHIO,dp,sup_ini,[],er_iter,original_object,delta_thscanvals,ki_o,kf_o,probe,d2_bragg,X,Y,Z,plotResults,flagER,flagER_direct);



er_iter = 150;
flagER = 1;
[retrphase,newobj,err_ERHIO,struct_rho_iter,counter] = Phretrieval_functions.do_ERHIO(err_ERHIO,dp,sup_ini,newobj,er_iter,original_object,delta_thscanvals,ki_o,kf_o,probe,d2_bragg,X,Y,Z,plotResults,flagER,flagER_direct);
...
er_iter = 120;
flagER = 1;
[retrphase,newobj,err_ERHIO,struct_rho_iter,counter] = Phretrieval_functions.do_ERHIO(err_ERHIO,dp,support_new,newobj,er_iter,original_object,delta_thscanvals,ki_o,kf_o,probe,d2_bragg,X,Y,Z,plotResults,flagER,flagER_direct);
...
hio_iter = 100;
flagER = 0;
[retrphase,newobj,err_ERHIO,struct_rho_iter,counter] = Phretrieval_functions.do_ERHIO(err_ERHIO,dp,support_new,newobj,hio_iter,original_object,delta_thscanvals,ki_o,kf_o,probe,d2_bragg,X,Y,Z,plotResults,flagER,flagER_direct);
